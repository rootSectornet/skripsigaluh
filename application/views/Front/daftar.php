    ...
    <h6>Daftar Member Baru</h6>
      ...
      <div class="row">
        <div class="span9 content-wrapper clearfix">
          ...
          <td>
          <li>
          <label><input type="text" name="username" placeholder="Nama Anda ..." size="50"/></label>
          </li>
          </td>
          </tr>
          ...
          <tr><td valign="top">Konfirmasi password</td>
          <td>
          <li>
          <label>
          <input type="password" name="repassword" placeholder="Konfirmasi Password Anda..." size="50"/>
          </label>
          </li>
          </td>
          </tr>
          ...
          <li>
          <label>
          <textarea name='alamat'  class='tbox' style='width: 450px; height: 150px;'></textarea><br>
          *) Alamat pengiriman harus di isi lengkap, termasuk kota/kabupaten dan kode posnya.
          ...
          <td>
          <li>
          <label><input type="number" name="telepon" placeholder="Telepon..." size="50"/></label>
          </li>
          </td>
          </tr>
          ...
          <td>
          <li>
          <label><input type="text" name="email" placeholder="email..." size="50"/></label>
          </li>
          </td>
          </tr>
