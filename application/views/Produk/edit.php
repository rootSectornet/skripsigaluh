          ...
          <div class="col-md-6 col-md-offset-3">
            <form method="post"   enctype="multipart/form-data" >
              <div class="form-group">
                ...
                <input type="text" name="produk" class="form-control" value="<?= @$produk->nama_produk;?>" required placeholder="Nama produk">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea name="keterangan" rows="5" class="form-control" required><?= @$produk->keterangan;?></textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="number" name="stock" class="form-control" required  value="<?= @$produk->stock;?>">
              </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" readonly id="textImg" value="<?= @$produk->gambar;?>">
                </div><br>
              <div class="form-group">
